...
# ✅ Sentiment Score Function (Based on User Data)
...
# ✅ Apply Preprocessing and Calculations
rfi_df['cleaned_questions'] = rfi_df['questions_body'].apply(preprocess_text_list)
rfi_df['urgency_score'] = rfi_df.apply(lambda row: calculate_urgency(row['priority_value'], row['priority_name'], row['due_date']), axis=1)
